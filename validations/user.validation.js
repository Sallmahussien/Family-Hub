...
class UsersValidator {
    static createUser (userDto) {
        ...
        const schema = joi.object({
            ...
            role: joi.string().valid('CREATOR', 'MEMBER').default('MEMBER'),
