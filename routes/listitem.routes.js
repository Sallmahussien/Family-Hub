...
router.route('/:circleId/users/:userId/feeds/:feedId/lists/:listId/listItems')
    .post(ListItemsController.createListItem)
    .get(ListItemsController.getListItemsByListId);

router.route('/:circleId/users/:userId/feeds/:feedId/lists/:listId/listItems/:listItemId')
